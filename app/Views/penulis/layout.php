...
<body>
        ...
        <aside class="left-sidebar">
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="<?= base_url('penulis/home') ?>" class="text-nowrap logo-img">
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= base_url('penulis/home') ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= base_url('penulis/artikel') ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= base_url('penulis/profile') ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= base_url('penulis/password') ?>" aria-expanded="false">
                                <span>
                                    <i class="ti ti-key"></i>
                                </span>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                    <div class="message-body">
                                        <a href="<?= base_url('penulis/profile') ?>" class="d-flex align-items-center gap-2 dropdown-item">
    ...
    <script>
        ...
        $('#keyword').on('input', function() {
            ...
            $.ajax({
                url: '<?= base_url('penulis/artikel/checkslug') ?>', //Endpoint untuk mengecek slug di backend
                method: 'POST',
                data: {
