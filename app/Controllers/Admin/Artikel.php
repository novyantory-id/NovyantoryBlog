...
class Artikel extends BaseController
{
    ...
    public function allarticlesview()
    {
        ...
        $data = [
            'title' => 'All Articles',
            'artikel' => $artikelModel->allarticlesadmin()
        ];
        return view('admin/artikel/allarticles', $data);
    }
    ...
    public function store()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            echo view('admin/artikel/create', $data);
        } else {
            $artikelModel = new ArtikelUserModel();
            $kategoriModel = new KategoriModel();
    ...
    public function myarticle()
    {
        ...
        return view('admin/artikel/myartikel', $data);
    }
}
