...
<form action="<?= base_url('penulis/artikel/update/' . $artikel['id']) ?>" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
    <div class="row">
        <div class="col-xl-8">
            <input type="text" name="user_id" value="<?= session()->get('writter_id') ?>">
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <button type="submit" class="btn btn-outline-primary 50 m-1">Update</button>
                    </div>
                </div>
            </div>
        </div>
